...
LIBFT = ./libft/libft.a
LIBFT_DIR = libft
SRCS = list1.c list2.c command1.c command2.c main.c push_swap_util.c sort.c list_command1.c list_command2.c sort_two.c sort_three.c sort_util1.c sort_four.c sort_five.c quick_sort_div.c quick_sort_size.c sort_three_2.c sort_five_2.c
